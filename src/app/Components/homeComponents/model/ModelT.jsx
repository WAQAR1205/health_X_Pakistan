  ...
  return (
    ...
    <group ref={groupRef} {...props}  dispose={null}>
      <group scale={0.01}  ref={ref} > 
        <group position={[0, 0,0]} rotation={[0, 0, 0]} scale={25} >
...
gsap.fromTo(el,{rotation: 45},{
 ...
 toggleActions : 'play , none , none , reverse '
  ...
  return (
    <div className=" relative h-full w-full flex flex-col  justify-center   overflow-auto"   >
        ...
        <Canvas  ref={imgref } class="bg-gradient-to-b from-orange-200 via-emerald-500 to-yellow-200 flex justify-center top-0"

        // camera={ {position: [4, 4 , 10 ] , fov: 85 }} 
